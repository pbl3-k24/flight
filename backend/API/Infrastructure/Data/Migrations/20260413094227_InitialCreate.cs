        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Aircraft_TotalSeats", "\"TotalSeats\" > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Promotion_UsageLimit", "\"UsageLimit\" IS NULL OR \"UsedCount\" <= \"UsageLimit\"");
                    table.CheckConstraint("CK_Promotion_ValidDateRange", "\"ValidTo\" > \"ValidFrom\"");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeFee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Route_AirportsDifferent", "\"DepartureAirportId\" <> \"ArrivalAirportId\"");
                    table.CheckConstraint("CK_Route_Distance", "\"DistanceKm\" > 0");
                    table.CheckConstraint("CK_Route_Duration", "\"EstimatedDurationMinutes\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultBasePrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AircraftSeatTemplates", x => x.Id);
                    table.CheckConstraint("CK_AircraftSeatTemplate_DefaultBasePrice", "\"DefaultBasePrice\" > 0");
                    table.CheckConstraint("CK_AircraftSeatTemplate_DefaultSeatCount", "\"DefaultSeatCount\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundPercent = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    PenaltyFee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefundPolicies", x => x.Id);
                    table.CheckConstraint("CK_RefundPolicy_RefundPercent", "\"RefundPercent\" >= 0 AND \"RefundPercent\" <= 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Flight_DepartureBeforeArrival", "\"ArrivalTime\" > \"DepartureTime\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Booking_FinalAmount", "\"FinalAmount\" = \"TotalAmount\" - \"DiscountAmount\"");
                    table.CheckConstraint("CK_Booking_RoundTrip_ReturnFlight", "\"TripType\" <> 1 OR \"ReturnFlightId\" IS NOT NULL");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_FlightSeatInventory_AvailableSeats", "\"AvailableSeats\" >= 0");
                    table.CheckConstraint("CK_FlightSeatInventory_HeldSeats", "\"HeldSeats\" >= 0");
                    table.CheckConstraint("CK_FlightSeatInventory_SoldSeats", "\"SoldSeats\" >= 0");
                    table.CheckConstraint("CK_FlightSeatInventory_TotalConsistency", "\"AvailableSeats\" + \"HeldSeats\" + \"SoldSeats\" <= \"TotalSeats\"");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    IssuedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW() AT TIME ZONE 'UTC'"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Default customer role", "User" },
                    { 3, "Operational staff role", "Staff" },
                    { 4, "Management role", "Manager" }
                });

            migrationBuilder.InsertData(
                table: "SeatClasses",
                columns: new[] { "Id", "ChangeFee", "Code", "Name", "Priority", "RefundPercent" },
                values: new object[,]
                {
                    { 1, 0m, "FIRST", "First", 1, 100m },
                    { 2, 0m, "BUS", "Business", 2, 100m },
                    { 3, 50m, "ECO", "Economy", 3, 80m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingPassengers_BookingId_FullName",
                table: "BookingPassengers",
                columns: new[] { "BookingId", "FullName" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailVerificationTokens_UserId_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_RouteId_DepartureTime",
                table: "Flights",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefundPolicies_SeatClassId_HoursBeforeDeparture",
                table: "RefundPolicies",
                columns: new[] { "SeatClassId", "HoursBeforeDeparture" },
                unique: true);
