...
namespace API.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260413094227_InitialCreate")]
            ...
            modelBuilder.Entity("API.Domain.Entities.Aircraft", b =>
                {
                    ...
                    b.ToTable("Aircraft", null, t =>
                        {
                            t.HasCheckConstraint("CK_Aircraft_TotalSeats", "\"TotalSeats\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Entities.AircraftSeatTemplate", b =>
                {
                    ...
                    b.ToTable("AircraftSeatTemplates", null, t =>
                        {
                            t.HasCheckConstraint("CK_AircraftSeatTemplate_DefaultBasePrice", "\"DefaultBasePrice\" > 0");

                            t.HasCheckConstraint("CK_AircraftSeatTemplate_DefaultSeatCount", "\"DefaultSeatCount\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Entities.Booking", b =>
                {
                    ...
                    b.ToTable("Bookings", null, t =>
                        {
                            t.HasCheckConstraint("CK_Booking_FinalAmount", "\"FinalAmount\" = \"TotalAmount\" - \"DiscountAmount\"");

                            t.HasCheckConstraint("CK_Booking_RoundTrip_ReturnFlight", "\"TripType\" <> 1 OR \"ReturnFlightId\" IS NOT NULL");
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Entities.Flight", b =>
                {
                    ...
                    b.ToTable("Flights", null, t =>
                        {
                            t.HasCheckConstraint("CK_Flight_DepartureBeforeArrival", "\"ArrivalTime\" > \"DepartureTime\"");
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Entities.FlightSeatInventory", b =>
                {
                    ...
                    b.ToTable("FlightSeatInventories", null, t =>
                        {
                            t.HasCheckConstraint("CK_FlightSeatInventory_AvailableSeats", "\"AvailableSeats\" >= 0");

                            t.HasCheckConstraint("CK_FlightSeatInventory_HeldSeats", "\"HeldSeats\" >= 0");

                            t.HasCheckConstraint("CK_FlightSeatInventory_SoldSeats", "\"SoldSeats\" >= 0");

                            t.HasCheckConstraint("CK_FlightSeatInventory_TotalConsistency", "\"AvailableSeats\" + \"HeldSeats\" + \"SoldSeats\" <= \"TotalSeats\"");
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Entities.Promotion", b =>
                {
                    ...
                    b.ToTable("Promotions", null, t =>
                        {
                            t.HasCheckConstraint("CK_Promotion_UsageLimit", "\"UsageLimit\" IS NULL OR \"UsedCount\" <= \"UsageLimit\"");

                            t.HasCheckConstraint("CK_Promotion_ValidDateRange", "\"ValidTo\" > \"ValidFrom\"");
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Entities.RefundPolicy", b =>
                {
                    ...
                    b.HasIndex("SeatClassId", "HoursBeforeDeparture")
                        .IsUnique();

                    b.ToTable("RefundPolicies", null, t =>
                        {
                            t.HasCheckConstraint("CK_RefundPolicy_RefundPercent", "\"RefundPercent\" >= 0 AND \"RefundPercent\" <= 100");
                        });
                });
            ...
            modelBuilder.Entity("API.Domain.Entities.Route", b =>
                {
                    ...
                    b.ToTable("Routes", null, t =>
                        {
                            t.HasCheckConstraint("CK_Route_AirportsDifferent", "\"DepartureAirportId\" <> \"ArrivalAirportId\"");

                            t.HasCheckConstraint("CK_Route_Distance", "\"DistanceKm\" > 0");

                            t.HasCheckConstraint("CK_Route_Duration", "\"EstimatedDurationMinutes\" > 0");
                        });
                });
